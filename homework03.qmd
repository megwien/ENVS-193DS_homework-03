...
Influence: 
I want this to look like a map but also similar to a cartoonish drawing. 

Form:
The form of the piece is going to be a painting on paint paper. The orugh draft is a digital version of what I will paint once I've ironed out the details.

Process:
I created the work by first looking at the original graph and then drawing a road that aligned with the points. Then I added in the elements of road signs and weather conditions. 
